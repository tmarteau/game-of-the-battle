...
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    rafalle_de_balle = 0
    balle_5.setPosition(mySprite.x, mySprite.y)
    balle_5.setVelocity(0, 0)
    balle_4.setPosition(mySprite.x, mySprite.y)
    balle_4.setVelocity(0, 0)
    balle_3.setPosition(mySprite.x, mySprite.y)
    balle_3.setVelocity(0, 0)
    balle_2.setPosition(mySprite.x, mySprite.y)
    balle_2.setVelocity(0, 0)
    balle.setPosition(mySprite.x, mySprite.y)
    balle.setVelocity(0, 0)
})
...
let rafalle_de_balle = 0
let balle_5: Sprite = null
let balle_4: Sprite = null
let balle_3: Sprite = null
...
mySprite = sprites.create(img`
    ...
    ........................
    `, SpriteKind.Player)
mySprite.setPosition(148, 89)
balle = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
...
forever(function () {
    if (rafalle_de_balle == 1) {
        balle.setVelocity(-50, 0)
    }
})
forever(function () {
...
forever(function () {
    if (rafalle_de_balle == 2) {
        balle_2.setVelocity(-50, 0)
    }
})
forever(function () {
    if (rafalle_de_balle == 3) {
        balle_3.setVelocity(-50, 0)
    }
})
forever(function () {
    if (rafalle_de_balle == 3) {
...
forever(function () {
    if (rafalle_de_balle == 5) {
        balle_5.setVelocity(-50, 0)
    }
})
forever(function () {
    if (rafalle_de_balle == 4) {
        balle_4.setVelocity(-50, 0)
    }
})
